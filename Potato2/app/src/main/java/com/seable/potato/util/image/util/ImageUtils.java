...
public class ImageUtils {
     ...
     * @return
     * @see com.seable.potato.util.image.util.ImageUtils#getInputStreamFromUrl(String, int, boolean)
     */
     ...
     * @param readTimeOutMillis
     * @return
     * @see com.seable.potato.util.image.util.ImageUtils#getDrawableFromUrl(String, int, boolean)
     */
     ...
     * @param readTimeOut
     * @return
     * @see com.seable.potato.util.image.util.ImageUtils#getBitmapFromUrl(String, int, boolean)
     */
