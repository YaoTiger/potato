...
import com.seable.potato.util.image.util.ListUtils;
import com.seable.potato.util.image.util.ObjectUtils;
import com.seable.potato.util.image.util.SerializeUtils;
 ...
 * <li>{@link #setOnGetDataListener(com.seable.potato.util.image.service.impl.PreloadDataCache.OnGetDataListener)} set how to get data, this cache will get data and preload data
 * by it</li>
 ...
 * <li>{@link com.seable.potato.util.image.service.impl.SimpleCache#setValidTime(long)} set valid time of elements in cache, in mills</li>
 * <li>{@link com.seable.potato.util.image.service.impl.SimpleCache#saveCache(String, com.seable.potato.util.image.service.impl.SimpleCache)} save cache to a file</li>
 * </ul>
 * <ul>
...
public class PreloadDataCache<K, V> extends SimpleCache<K, V> {
     ...
     * @see com.seable.potato.util.image.service.impl.PreloadDataCache#get(Object)
     */
     ...
     * <li>call {@link com.seable.potato.util.image.service.impl.PreloadDataCache.OnGetDataListener#onGetData(Object)} to get data and wait for it finish</li>
     * </ul>
     *
     * @param key
     * @return element if this cache contains the specified key, else get data realtime and wait for it
    ...
    /**
     * <ul>
     * <li>Maximum size of the cache is {@link com.seable.potato.util.image.service.impl.SimpleCache#DEFAULT_MAX_SIZE}</li>
     * <li>Elements of the cache will not invalid, can set by {@link com.seable.potato.util.image.service.impl.SimpleCache#setValidTime(long)}</li>
