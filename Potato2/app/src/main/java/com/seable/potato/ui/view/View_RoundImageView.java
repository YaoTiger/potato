 ...
 * @Description: 圆ImageView
 * @date 2015-01-20 14:33
 */
public class View_RoundImageView extends ImageView {

    private Context context;

    public View_RoundImageView(Context context, AttributeSet attrs) {
        super(context, attrs);
...
//        }
    ...
    public void draw(Canvas canvas) {
        canvas.saveLayer(roundRect, zonePaint, Canvas.ALL_SAVE_FLAG);
//                canvas.drawRoundRect(roundRect, rect_adius, rect_adius, zonePaint);
        //Canvas.drawCircle(float cx 距离x的距离, float cy距离y的距离, float radius 直径, Paint paint)
