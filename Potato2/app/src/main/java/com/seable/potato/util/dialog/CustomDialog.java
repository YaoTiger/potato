package com.seable.potato.util.dialog;//package com.seable.withome.property.util.dialog;
//
//
//import com.seable.withome.R;
//
...
//
//	private LinearLayout mCustomViewLL;
//	private static int mDuration = -1;
//	
//	public CustomDialog(Context context,boolean system) {
...
//		mDialog.setContentView(R.layout.dialog_custom_layout);
//		
...
//		mCustomViewLL = (LinearLayout) findViewById(R.id.dialog_ll);
//	}
//	
...
//				R.layout.dialog_custom_list_item, R.id.item_text, items);
...
//		ArrayAdapter<String> adapter = new ArrayAdapter<String>(getContext(), 
//				R.layout.dialog_custom_list_single_choice_item, R.id.item_text, items) {
//			
//			@Override
