 ...
 */
package com.seable.potato.util.addImage;
 ...
 *
 * @author 王维玉copy
 * @ClassName: DiskLruCache
 * @Description: 添加照片相关
 * @date 2015-01-17 15:18
 */
public class DiskLruCache {
    ...
    /**
     * Constructor that should not be called directly, instead use {@link com.seable.potato.util.addImage.DiskLruCache#openCache(android.content.Context, java.io.File, long)} which runs some extra checks before creating a DiskLruCache
     * instance.
     *
     * @param cacheDir
     * @param maxByteSize
    ...
    /**
     * Removes all disk cache entries from the given directory. This should not be called directly, call {@link com.seable.potato.util.addImage.DiskLruCache#clearCache(android.content.Context, String)} or
     * {@link com.seable.potato.util.addImage.DiskLruCache#clearCache()} instead.
     *
    ...
    /**
     * Writes a bitmap to a file. Call {@link com.seable.potato.util.addImage.DiskLruCache#setCompressParams(android.graphics.Bitmap.CompressFormat, int)} first to set the target bitmap compression and format.
     *
     * @param bitmap
     * @param file
     * @return
