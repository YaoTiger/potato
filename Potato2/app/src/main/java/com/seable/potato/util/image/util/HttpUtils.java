...
import com.seable.potato.util.image.service.HttpCache;
 ...
 * <li>{@link #httpGet(HttpRequest, com.seable.potato.util.image.util.HttpUtils.HttpListener)} http get asynchronous</li>
 * <li>{@link #httpGet(String, com.seable.potato.util.image.util.HttpUtils.HttpListener)} http get asynchronous</li>
 * </ul>
 * <ul>
...
public class HttpUtils {
     ...
     * @param httpUrl
     * @return the response of the url, if null represents http error
     * @see com.seable.potato.util.image.util.HttpUtils#httpGet(HttpRequest)
     */
     ...
     * @param httpUrl
     * @return the response of the url, if null represents http error
     * @see com.seable.potato.util.image.util.HttpUtils#httpPost(HttpRequest)
     */
     ...
     *                 {@link com.seable.potato.util.image.util.HttpUtils#joinParas(java.util.Map)}
     * @return the content of the url, if null represents http error
     * @see com.seable.potato.util.image.util.HttpUtils#httpPost(HttpRequest)
     */
