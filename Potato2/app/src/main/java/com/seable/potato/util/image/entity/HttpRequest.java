 ...
 * <li>{@link com.seable.potato.util.image.entity.HttpRequest#HttpRequest(String)}</li>
 * <li>{@link com.seable.potato.util.image.entity.HttpRequest#HttpRequest(String, java.util.Map)}</li>
 * </ul>
 * <ul>
